    ...
    <body>
            ...
            <div class="class-ow-jo" style="margin-top:30px;">
                ...
                <ul class="menu-class">
                    <li class="menu-class-child class-selected">
                        <img alt="avatarclass"  src="img/classesAvatar/avatar_baseball.png"/>
                        <font>
                    ...
                    <li class="menu-class-child">
                        <img alt="avatarclass" src="img/classesAvatar/avatar_apple_default.png" />
                    ...
                    <li class="menu-class-child">
                        <img alt="avatarclass" src="img/classesAvatar/avatar_history.png"/>
                        <font>
                             Lập trình ứng dụng
                        </font>
                    </li>
        ...
        <div class="classes-main-right" >
            <div class="mot-hang-70" style= "height:2px;">
                <div class="mot-hang">
                    <img alt="image-main" style="float:left;margin-right:15px;" src="img/classesAvatar/avatar_baseball.png" height="65px"/>
            ...
            <div class="form-chua form-setting-class">
                ...
                <div id="class-setting-information">
                    ...
                    <div style="padding:10px 5% 0px 5%;float:left;width:90%;">
                        <div class="mot-hang" style="margin-top:30px;">
                            <div class="mot-hang-30">
                                <img alt="image-random" width="90px" />
        ...
        <div class="khung-chua" id="khung-chua-add-class">
            ...
            <div class="form-chua form-add-class">
                ...
                <div class="mot-hang" style="margin-top:30px;">
                    <div class="mot-hang-30">
                        <img alt="image-random" width="90px" id="image-randomId" src=""/>
